...
namespace eBACSMobileV2
{
    ...
    public class UploadDataActivity : Activity
    {
        ...
        TextView customer, bill,historyreader,findi,mtrreport, bill__charges;
        ProgressBar progg;
        ...
        List<tblbillchargesSQLite> mBillCharges;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            bill__charges = FindViewById<TextView>(Resource.Id.lblbillcharges);
            ...
            mBillCharges = new List<tblbillchargesSQLite>();
            ...
            try
            {
                using (var connection = new SQLiteConnection(System.IO.Path.Combine(folder, "eBacsMobile.db")))
                {
                    ...
                    mBillCharges = connection.Query<tblbillchargesSQLite>("SELECT * FROM tblbillchargesSQLite");
        ...
        private void Startupload_Click(object sender, EventArgs e)
        {
            ...
            if (current == Xamarin.Essentials.NetworkAccess.Internet)
            {
                ...
                for (int j = 0; j < mBillCharges.Count; j++)
                {
                    mclientbills = new WebClient();

                    mUrl = new Uri("http://" + serverip[0].ipaddress + "updatebillscharges.php?bill_amount=" + mBillCharges[j].Amount + "&billchargesID=" + mBillCharges[j].BillChargesID);
                ...
                bill__charges.Text = "Bill Charges Update: " + mBillCharges.Count;
                pro = pro + 1;
                progvisible();
